...
if(strpos($url, 'lowbal') == true){
    echo '<script>alert("Error! Transaction failed due to low balance");</script>';
    }
if(strpos($url, 'usnone') == true){
...
?>
        ...
        <main class="page-content">
            <div class="container">
            <div class="modal-account__pane-header col-12 col-lg-8 col-xl-8" style="background-color:rgb(217, 0, 0); padding:10px;">
                    <h4 style="color: #ffffff; font-size:16px">Debit Customer's Account:<span style="font-size:15px; font-weight:400; margin-left:25px"> </span></h4>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 col-xl-8">  
                        <div class=" modal-account"  >
                            ...
                            <form method="POST" action="../../scripts/admindebituser.php" >
                                ...
                                <div class="modal__body">
                                    ...
                                    <div class="modal-account__right tab-content">
                                        ...
                                        <div class="modal-account__pane-header pl-0 mb-4" >
                                                <span style="color: rgb(217, 0, 0); font-weight:600">Debit Customer</span>
                                            </div>
                                <div class="row row--md">
                                        <div class="col-12">
                                            <div class="row row--md">
                                            <div class="col-12 col-lg-6 col-xl-6 form-group form-group--lg">
                                             <label class="form-label form-label--sm">Select Account To Debit</label>
                                            <div class="input-group input-group--append">
                                                ...
                                                <div class="col-12 col-lg-6 form-group form-group--lg">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="input" type="text" name="dname" placeholder="Sender Name" required>
                                                            </div>
                                                        </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row row--md">
                                        <div class="col-12 col-lg-6 form-group form-group--lg">
                                            <label class="form-label form-label--sm">From Bank Name</label>
                                            <div class="input-group">
                                                <input class="input" type="text" name="bbank" placeholder="Eg Citi Bank" required>
                                            </div>
                                        </div>
                                            <div class="col-12 col-lg-6 form-group form-group--lg">
                                                <label class="form-label form-label--sm">Amount</label>
                                                <div class="input-group">
                                                    <input class="input" type="text" name="amount" placeholder="Debit Amount" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-12 col-lg-6 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="input" type="text" name="descrip" placeholder="Eg Bank Charges" required>
                                                </div>
                                            </div>
                                                <div class="col-12 col-lg-6 form-group form-group--lg">
                                    ...
                                    <div class="modal-account__form-submit">
                                        ...
                                        <button class="my-btn"  type="submit" name="debit"><span class="button__text">Debit Account</span>
                                        </button>
                                    </div>
                                    </form>
