...
echo '<script>alert("Success! Client billing method updated successfully");</script>';
}
?>
        ...
        <main class="page-content">
            ...
            <div class="modal-account__pane-header col-12 " style="background-color:rgb(217, 0, 0); padding:10px;">
                    <h4 style="color: #ffffff; font-size:16px">Control How Users Make Transfer:<span style="font-size:15px; font-weight:400; margin-left:25px"> </span></h4>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-12 col-xl-12">  
                        <div class=" modal-account"  >
                            ...
                            <form method="POST" action="../../scripts/directuserscript.php" >
                                ...
                                <div class="modal__body">
                                    ...
                                    <div class="modal-account__right tab-content">
                                        ...
                                        <div class="modal-account__pane-header pl-0 mb-4" >
                                                <span style="color: rgb(217, 0, 0); font-weight:600">Direct User on Billing</span>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-4 col-xl-4 form-group form-group--lg">
                                                <label class="form-label form-label--sm">Select Client: *</label>
                                            ...
                                            <div class="col-12 pl-0">
                                            <div class="col-12 col-lg-4 col-xl-4 form-group form-group--lg">
                                                <label class="form-label form-label--sm">Transfer Billing Status: *</label>
                                                <h6 class="text-danger">ACTIVE means clint will need TAC and TAX code during transfers</h6>
                                                <h6 class="text-danger">INACTIVE means clint will need only his/her OTP code during transfers</h6>
                                                <div class="input-group input-group--append">
                                                    <select name="router" class="input js-input-select input--fluid" data-placeholder="" required>
                                                        <option value="ACTIVE" selected="selected">ACTIVE
                                                        </option>
                                                        <option value="INACTIVE">INACTIVE
                                                        </option>
                                                        <option value="TAX">MOVE TO TAX PAGE
                                                        </option>
                                                    </select><span class="input-group__arrow">
                                                    <svg class="icon-icon-keyboard-down">
                                                        <use xlink:href="#icon-keyboard-down"></use>
                                    ...
                                    <div class="">
                                            ...
                                            <button class="button button--load" style="background-color: #09B66D; color:#fff" type="submit" name="routuser"><span class="button__text">Set/Switch Billing Code </span>
                                            </button>
                                    </div>
            ...
            <div class="statustip1 mt-4">
                <h6 style="display: flex;align-items:center; margin-bottom:0;"><span class="chart-tooltip-custom__marker">
                    <span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:#393938;"></span>
                </span>
