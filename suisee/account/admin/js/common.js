...
var calendarMonth = [
    ...
    function e() {
      _classCallCheck(this, e),
        ...
        (this.options = {
          ...
          locale: {
            weekdays: { shorthand: this.weekDay },
            rangeSeparator: " / ",
          },
          onReady: function () {},
  ...
  CalendarInline = (function () {
    function n(e) {
      ...
      _classCallCheck(this, n),
        (this.calendar = document.querySelector(e)),
        (this.widget = document.querySelector(
          '[data-calendar="'.concat(e, '"]')
        )),
        (this.weekDay = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"]),
    ...
    return (
      _createClass(n, [
        ...
        },
        {
          key: "ready",
          value: function (e) {
            var t = e.querySelector(".cur-year"),
              n = document.createElement("div");
            (n.classList = "calendar-inline__year text-grey"),
              (n.innerHTML = t.value),
              t.parentNode.prepend(n);
          },
        },
        {
          key: "getYear",
          value: function (e, t, n) {
            this.calendar.querySelector(".calendar-inline__year").textContent =
              n.currentYear;
          },
        },
        {
          key: "renderWidget",
          value: function (e, t, n) {
            var o = this.widget.querySelector(".calendar-widget__dateday"),
              r = this.widget.querySelector(".calendar-widget__month"),
              i = this.widget.querySelector(".calendar-widget__weekday");
            (o.textContent = e),
              (r.textContent = calendarMonth[t]),
              (i.textContent = this.weekDay[n]);
          },
        },
        {
          key: "createEvents",
          value: function (e, t, n, o) {
            var r = o,
              ...
              a = r.dateObj;
            (i.classList = "event"),
              new Date().getTime() - 1728e5 > a.getTime() - 864e5 &&
                new Date().getTime() - 1728e5 < a.getTime() &&
                r.append(i),
              new Date().getTime() + 1728e5 < a.getTime() + 864e5 &&
                new Date().getTime() + 1728e5 > a.getTime() &&
                (i.classList.add("event--upcoming"),
                r.append(i),
                this.renderWidget(a.getDate(), a.getMonth(), a.getDay())),
              new Date().getTime() + 432e6 < a.getTime() + 864e5 &&
                new Date().getTime() + 432e6 > a.getTime() &&
                (i.classList.add("event--upcoming"), r.append(i));
          },
        },
      ]),
      n
        ...
        this.events[0] &&
          (this.events.forEach(function (e) {
            ...
            e.addEventListener("click", function (e) {
              return n.showEvent(e);
            }),
              t &&
                t.addEventListener("click", function (e) {
                  return n.eventRemove(e);
                });
          }),
          window.addEventListener("click", function (e) {
            return n.closeAllEvent(e);
          })),
        this.reminders[0] &&
          this.reminders.forEach(function (e) {
            e.querySelector('[data-toggle="remove"]').addEventListener(
              "click",
              function (e) {
                return n.reminderRemove(e);
              }
            );
          }),
        this.switcherDate[0] && this.switcherDate.forEach(e.switcherDateToggle);
    }
    return (
      _createClass(
        e,
        [
            ...
            value: function (e) {
              ...
              e.preventDefault(),
                t.classList.contains("active") ||
                  t.classList.contains("c-event--active") ||
                  t.classList.contains("c-event--draggable") ||
                  (n.classList.contains("show") && n.classList.remove("show"),
                  this.events.forEach(function (e) {
                    return e.classList.remove("active");
                  }),
                  t.classList.add("active"),
                  n.classList.remove(this.eventColor),
                  (this.eventColor = t.getAttribute("data-color")),
                  setTimeout(function () {
                    n.classList.add("show");
                  }, 10),
                  n.classList.add(this.eventColor));
            },
          },
          {
            key: "closeAllEvent",
            value: function (e) {
              e.target.closest(".c-event") ||
                e.target.closest(".dropdown-c-event") ||
                this.events.forEach(function (e) {
          ...
          },
          {
            key: "eventRemove",
            value: function (e) {
              var t = e.currentTarget.closest(".c-event");
              (t.style.opacity = 0),
                setTimeout(function () {
                  return t.remove();
                }, 300);
        ...
        [
          {
            key: "switcherDateToggle",
            value: function (e) {
              var t = e.querySelector(".switcher-date__input"),
                n = document.querySelector(".calendar-toolbox__month"),
                o = e.querySelector(".js-input-select"),
                r = document.querySelectorAll(".switcher-date__btn");
              if (t) {
                var i = o.options.length,
                  a = o.options.selectedIndex,
                  s = !1,
                  c = function (e) {
                    setTimeout(function () {
                      n.classList.add(e);
                ...
                t.addEventListener("click", function () {
                  $(o).select2("open"), (a = o.options.selectedIndex);
                }),
                  $(o).on("change", function () {
                    var e = o.options[o.selectedIndex].text;
                    (t.innerHTML = e),
                      n.classList.remove("is-previous"),
                      n.classList.remove("is-next"),
                      s ||
                        (o.options.selectedIndex < a
                          ? c("is-previous")
                          : c("is-next")),
                      (s = !1),
                      (a = o.options.selectedIndex),
                  ...
                  r.forEach(function (e) {
                    e.addEventListener("click", function (e) {
                      ...
                      if ("prev" === t) {
                        if (0 === o.options.selectedIndex)
                          return (
                            (s = !0),
                            (o.options.selectedIndex = i - 1),
                            c("is-previous"),
                            void $(o).trigger("change")
                          );
                        o.options.selectedIndex--;
                      }
                      if ("next" === t) {
                        if (o.options.selectedIndex === i - 1)
                          return (
                            (s = !0),
  ...
  echartsElements = [],
  ChartProgressCircle = (function () {
    function e() {
      _classCallCheck(this, e),
        (this.element = document.querySelectorAll(".js-progress-circle")),
        this.element[0] && this.element.forEach(this.onInit.bind(this));
    }
    return (
      _createClass(e, [
        {
                ...
                custom: function (e) {
                  ...
                  return (
                    t.forEach(function (e) {
                      r +=
                        '\n                    <span class="chart-tooltip-custom__value">'.concat(
                          e[n],
                          '</span>\n                    <span class="chart-tooltip-custom__separate-item"></span>\n                '
                        );
                    }),
                    '\n                <div class="chart-tooltip-custom">\n                    <div class="chart-tooltip-custom__items">'
                      .concat(
                        r,
                        '</div>\n                    <div class="chart-tooltip-custom__title">Jan '
                      )
                      .concat(
                        o.globals.labels[n],
                        "</div>\n                </div>\n            "
              ...
              return {
                ...
                formatter: function (e) {
                  var t = document.createElement("div"),
                    n = "";
                  return (
                    (t.className = "chart-tooltip-custom"),
                    e.forEach(function (e) {
                      var t = o ? o(e) : e.value;
                      n +=
                        '\n                    <span class="chart-tooltip-custom__marker">'
                          .concat(
                            e.marker,
                            '</span>\n                    <span class="chart-tooltip-custom__value">'
                          )
                          .concat(
                            t,
                            '</span>\n                    <span class="chart-tooltip-custom__separate-item"></span>\n                '
                    ...
                    (t.innerHTML =
                      '\n                <div class="chart-tooltip-custom__items">'
                        .concat(
                          n,
                          '</div>\n                <div class="chart-tooltip-custom__title">'
                        )
                        .concat(e[0].name, "</div>\n            ")),
                    t
                  );
                },
                position: function (e, t, n, o, r) {
                  var i =
                      e[1] <= r.contentSize[1] + 30
                        ? 40
                        : e[1] - r.contentSize[1] - 10,
                    a = r.viewSize[0] - e[0] <= r.contentSize[0] / 2,
                    s = e[0] <= r.contentSize[0] / 2;
                  return a
                    ? { right: 0, top: i }
                    : s
                    ? { left: 0, top: i }
                    : { left: e[0] - r.contentSize[0] / 2, top: i };
                },
    ...
    function e() {
      _classCallCheck(this, e),
        (this.revenueLineChartOptions = {
          series: [
            {
              ...
              data: e.dataSeries("#revenueChart")[0],
            },
            { name: "Page Views", data: e.dataSeries("#revenueChart")[1] },
          ],
          ...
          fill: {
            ...
            gradient: {
              ...
              opacityFrom: [themeStyle(0.15, 0.15, !1), 1],
              opacityTo: [themeStyle(0.15, 0.15, !1), 1],
              stops: [0, 88],
            },
          },
          markers: {
        ...
        (this.profitPieChartOptions = {
          series: e.dataSeries("#profitPieChart"),
          ...
          xAxis: [
            {
              ...
              offset: 19,
              axisTick: { show: !1 },
              data: e.dataSeries("#activityChart")[0],
              axisLabel: {
                fontSize: 12,
                fontFamily: themeStyle("--font-family-default"),
                color: themeStyle("--text-secondary-color"),
              ...
              axisLine: {
                lineStyle: { color: themeStyle("--border-grey-color") },
              },
            },
          ],
          yAxis: [
          ...
          series: [
            {
              ...
              type: "bar",
              barGap: 0,
              data: e.dataSeries("#activityChart")[1],
              itemStyle: { borderRadius: [5, 5, 0, 0] },
            },
            {
              name: "Comment",
              type: "bar",
              data: e.dataSeries("#activityChart")[2],
              itemStyle: { borderRadius: [5, 5, 0, 0] },
            },
          ],
        }),
        (this.taskRarialChartOptions = {
          series: e.dataSeries("#taskPieChart"),
        ...
        (this.overviewLineChartOptions = {
          series: [
            {
              name: "Session Duration",
              data: e.dataSeries("#overviewLineChart"),
            },
          ],
          chart: {
            height: "100%",
          ...
          xAxis: [
            {
              ...
              offset: 19,
              axisTick: { show: !1 },
              data: e.dataSeries("#statisticsBarChart")[0],
              axisLabel: {
                fontSize: 12,
                fontFamily: themeStyle("--font-family-default"),
                color: themeStyle("--text-secondary-color"),
          ...
          series: [
            {
              ...
              type: "bar",
              barGap: 0,
              data: e.dataSeries("#statisticsBarChart")[1],
              itemStyle: { borderRadius: [5, 5, 0, 0] },
            },
            {
              name: "Target",
              type: "bar",
              data: e.dataSeries("#statisticsBarChart")[2],
              itemStyle: { borderRadius: [5, 5, 0, 0] },
            },
          ],
        }),
      ...
      _createClass(e, null, [
        {
          ...
          value: function (e) {
            ...
            if (!t) return !1;
            var n = t.getAttribute("data-series");
            return JSON.parse(n);
          },
        },
      ]),
  ...
  Chat = (function () {
    function e() {
      _classCallCheck(this, e),
        ...
        (this.buttonToggleUsers = document.querySelector(
          ".chat-details__toggle"
        )),
        (this.detailsBackdrop = document.querySelector(
        ...
        [
          {
            ...
            value: function () {
              var t = this;
              this.buttonToggleUsers.addEventListener("click", function (e) {
                return t.usersOpen(e);
              }),
                this.detailsBackdrop.addEventListener("click", function () {
                  return t.usersClose();
                }),
                this.userAddToggleElement.addEventListener(
                  "click",
                  function (e) {
      ...
      _createClass(e, [
        {
          ...
          value: function (o) {
            o
              .querySelectorAll(".credit-card__number-item")[0]
              .addEventListener("fit", function (e) {
                o.querySelector(".credit-card__number-wrapper").style.fontSize =
                  "".concat(Math.floor(e.detail.newValue), "px");
              }),
              o
                .querySelectorAll(".credit-card__date span")[0]
                .addEventListener("fit", function (e) {
                  var t = o.querySelector(".credit-card__name"),
                    n = o.querySelector(".credit-card__date");
                  (t.style.fontSize = "".concat(
                    Math.floor(e.detail.newValue),
                    "px"
                  )),
                    (n.style.fontSize = "".concat(
                      Math.floor(e.detail.newValue),
                      "px"
                    ));
                }),
              _toConsumableArray(
                o.querySelectorAll(".credit-card__number-item")
              ).forEach(function (e) {
                e.addEventListener("fit", function (e) {
        ...
        },
        {
          ...
          value: function (e) {
            ...
            !this.toggleButton.classList.contains("active") ||
              ...
              e.target.closest(".header__toggle-search") ||
  ...
  ModuleSearch = (function () {
    function e() {
      _classCallCheck(this, e),
        (this.toggleButton = document.querySelectorAll(
          ".toggle-search--module"
        )),
        (this.getActiveElement = null),
        (this.search = null),
        (this.input = null),
        this.toggleButton[0] && this.onInit();
    }
    return (
      _createClass(e, [
        {
          ...
          value: function () {
            var n = this;
            this.toggleButton.forEach(function (e, t) {
              e.addEventListener("click", function (e) {
                return n.toggle(e, t);
              });
            }),
        ...
        },
        {
          ...
          value: function (e, t) {
            var n = this,
              o = e.currentTarget;
            e.preventDefault(),
              (this.getActiveElement = t),
              (this.search = document.querySelector(
                o.getAttribute("data-search")
              )),
        ...
        },
        {
          ...
          value: function (e) {
            var t = this;
            null !== this.getActiveElement &&
              this.search.classList.contains("show") &&
              (!this.toggleButton[this.getActiveElement].classList.contains(
                "active"
              ) ||
                e.target.closest(".module-search") ||
                e.target.closest(".toggle-search--module") ||
                (this.toggleButton[this.getActiveElement].classList.remove(
                  "active"
                ),
                this.search.classList.remove("show"),
                setTimeout(function () {
          ...
          value: function (e) {
            ...
            e.preventDefault(),
              ...
              (t = setInterval(function () {
                timeline.resize(), fitty.fitAll();
              })),
              setTimeout(function () {
                clearInterval(t), Echart.resize();
              }, 310),
              this.body.classList.contains("sidebar-active")
                ? setTimeout(function () {
                    n.body.classList.remove("sidebar-active");
                  }, 300)
          ...
          value: function (e, t) {
            ...
            e.preventDefault(),
              ...
              t
                ...
                : setTimeout(function () {
                    n.sidebar.classList.remove("sidebar--show");
                  }, 300);
          },
        },
      ]),
  ...
  SidebarPanel = (function () {
    function e() {
      _classCallCheck(this, e),
        (this.buttonToggleElement = document.querySelector(
          ".js-toggle-sidebar-panel"
        )),
        (this.dismissElement = document.querySelector(
          ".backdrop-sidebar-panel"
        )),
        (this.sidebar = null),
        this.buttonToggleElement && this.onInit();
    }
    return (
      _createClass(e, [
        {
          ...
          value: function () {
            var t = this;
            this.buttonToggleElement.addEventListener("click", function (e) {
  ...
  ImageUpload = (function () {
    function s() {
      ...
      _classCallCheck(this, s),
        ...
        this.dropElement &&
          this.dropElement.forEach(function (t) {
            t
              .querySelector(".image-upload__drop")
      ...
      _createClass(
        ...
        [
          ...
          },
          {
            ...
            value: function (t) {
              var n = this,
                e = t.target.files || t.dataTransfer.files;
              this.dragHover(t),
                e.forEach(function (e) {
                  n.parseFile(e, t.currentTarget), n.uploadFile(e);
                });
            },
          },
          {
              ...
              (i.classList = "image-upload__item"),
                ...
                r[0]
                  ...
                  .addEventListener("click", function (e) {
                    return s.removeItem(e, r);
                  }),
                r[0].classList.add("is-active");
            },
          },
          {
            key: "uploadFile",
        ...
        [
          {
            ...
            value: function (e, t) {
              var n = e.target,
                ...
                r = n.parentNode,
                i = o.querySelectorAll(".image-upload__item");
              r.classList.remove("is-active"),
                5 < i.length && t[0].remove(),
                r.classList.contains("image-upload__item--added") && r.remove(),
                n.remove();
            },
          },
        ]
        ...
        },
        {
          ...
          value: function (e) {
            var t = e.currentTarget,
              ...
              o = t.querySelector(".profile-upload__image");
            if ((this.dragHover(e), n && n[0])) {
              var r = new FileReader();
              (r.onload = function (e) {
                o.setAttribute("xlink:href", "".concat(e.target.result));
              }),
                (r.onloadend = function (e) {
                  t.classList.add("is-animate"),
                    setTimeout(function () {
  ...
  OrderTabs = (function () {
    function e() {
      _classCallCheck(this, e),
        ...
        this.element &&
          ((this.elementSlider = this.element.querySelector(
            ".order-tabs__list-wrapper"
          )),
          (this.navButton =
            this.element.querySelectorAll(".order-tabs__arrow")),
          this.onInit());
    }
    return (
      _createClass(e, [
            ...
            new Swiper(this.elementSlider, {
              ...
              on: {
                init: function () {
                  var n = this;
                  document
                    .querySelectorAll(".order-tabs__item")
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            var e = this.element,
              t = new Swiper(this.thumbsSliderElement, {
                direction: "vertical",
                slidesPerView: "auto",
              ...
              n = new Swiper(this.mainSliderElement, {
                effect: "fade",
                speed: 500,
                slidesPerView: 1,
                simulateTouch: !1,
            ...
            e.addEventListener("gallery.close", function () {
              n.slideTo(+e.dataset.activeSlide, 0);
            });
          },
        },
      ]),
        ...
        [
          {
            ...
            value: function (e, t, n) {
              var o = this,
                r = e,
                i = r.querySelector(".product-cart__quantity input"),
                a = r.querySelector(".product-cart__price"),
                s = r.querySelector(".product-cart__remove"),
                c = a.textContent.slice(0, 1),
                l = a.textContent.slice(1) / i.value;
              (this.productsLenght = n.length),
                i.addEventListener("input", function (e) {
                  return u.counter(e, a, c, l);
                }),
                s.addEventListener("click", function (e) {
                  return o.removeItem(e, r);
                });
            },
          },
          {
            ...
            value: function (e, r) {
              ...
              this.productsLenght--,
                $(r).fadeOut(300, function () {
                  if ((r.remove(), 0 === i.productsLenght)) {
                    var e = document.querySelector(".cart"),
                      t = document.querySelector(".cart-empty__title"),
                      n = document.querySelector(".cart-empty__button"),
                      o = gsap.timeline();
                    e.classList.add("is-empty"),
                      gsap.set(t, {
                        clipPath: "polygon(0 0, 0 0, 0 100%, 0 100%)",
                      }),
                      gsap.set(n, { autoAlpha: 0, y: 20 }),
                      o
                        .to(t, {
                          clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)",
                          duration: 0.6,
                        })
                        .to(n, { autoAlpha: 1, y: 0, duration: 0.4 }, "-=0.3");
                  }
                });
            },
          },
        ...
        [
          {
            ...
            value: function (e, t, n, o) {
              var r = e.target,
                i = t;
              Number(r.value) <= r.min && (r.value = r.min),
                Number(r.value) >= r.max && (r.value = r.max),
                (i.textContent = "".concat(n).concat(r.value * o));
            },
          },
        ]
      ),
            ...
            this.element.forEach(function (e) {
              var t = e,
                n = document.querySelectorAll(
                  '[data-checkbox="'.concat(t.dataset.checkboxAll, '"]')
                );
              r.push(n),
                e.addEventListener("click", function (e) {
                  return o.checkedAll(e);
                });
            }),
              r.forEach(function (e) {
                e.forEach(function (e) {
                  e.addEventListener("click", function (e) {
                    return o.checkedInput(e);
                  });
                });
              });
          },
        },
        {
          ...
          value: function (e) {
            ...
            n.forEach(function (e) {
              var t = e;
              t.checked ? o.push(e) : triggerEvent("click", t);
            }),
              o.length === n.length
                ? ((t.checked = !1),
                  n.forEach(function (e) {
          ...
          value: function (e) {
            var t = e.currentTarget,
              n = document.querySelector(
                '[data-checkbox-all="'.concat(t.dataset.checkbox, '"]')
              ),
              o = document.querySelectorAll(
                '[data-checkbox="'.concat(n.dataset.checkboxAll, '"]')
              ),
              r = [];
            o.forEach(function (e) {
              ...
              r.length === o.length ? (n.checked = !0) : (n.checked = !1);
          },
        },
      ]),
      e
          ...
          value: function () {
            ...
            this.elements[0] &&
              (this.elements.forEach(function (e) {
                var t = e;
                new Masonry(t, n.options).once("layoutComplete", function () {
                  t.classList.add("load");
                });
              }),
              gsap.set(this.items, { y: 40, autoAlpha: 0 }),
  ...
  Todo = (function () {
    function e() {
      _classCallCheck(this, e),
        ...
        this.item[0] && this.item.forEach(this.onInit.bind(this));
    }
    return (
      _createClass(e, [
        {
          ...
          value: function (e) {
            var t = this;
            e.querySelector('[data-checkbox="todo-panel"]').addEventListener(
              "click",
              function (e) {
                return t.checked(e);
              }
        ...
        },
        {
          ...
          value: function (e) {
            var t = e.currentTarget,
              n = t.closest(".todo-panel");
            t.checked
              ? n.classList.add("todo-panel--checked")
              : n.classList.remove("todo-panel--checked");
          },
        },
      ]),
      e
  ...
  SwitcherGroup = (function () {
    function o() {
      _classCallCheck(this, o),
        (this.element = document.querySelectorAll(".switcher-button")),
        (this.floatElement = document.querySelectorAll(
    ...
    return (
      _createClass(
        ...
        [
          ...
          {
            key: "floatElementPosition",
            value: function () {
              this.floatElement.forEach(function (e) {
                var t = e,
                  n = t.closest(".switcher-button").querySelector(".active");
                o.getWidth(t, n);
              });
            },
          },
          {
            ...
            value: function (e) {
              var t = e.target,
                n = t.closest(".switcher-button"),
                o = n.querySelector(".switcher-button__float");
              t.parentNode.classList.contains("active") ||
                t.classList.contains("switcher-button__items") ||
                (n
                ...
                (o.style.transform = "translateX(".concat(
        ...
        [
          {
            ...
            value: function (e, t) {
              var n = e;
              setTimeout(function () {
                (n.style.width = "".concat(t.offsetWidth, "px")),
  ...
  FormEditor = (function () {
    function t(e) {
      _classCallCheck(this, t),
        ...
        (this.formEditorIcons.background =
      ...
      _createClass(t, [
        {
          key: "onInit",
          value: function () {
            new Quill(this.elementId, this.options);
          },
        },
      ]),
      t
          ...
          value: function () {
            ...
            document.querySelectorAll(".js-card-number").forEach(function (e) {
              ...
              document.querySelectorAll(".js-card-date").forEach(function (e) {
                new Cleave(e, {
                  date: !0,
                  dateMin: "".concat(t.year, "-").concat(t.month),
                  datePattern: ["m", "Y"],
                });
              }),
              ...
              document
                .querySelectorAll(".js-phone-number")
                .forEach(function (e) {
                  new Cleave(e, {
                    phone: !0,
                    delimiter: "-",
        ...
        },
        {
          ...
          value: function (e) {
            $(e).starRating({
              ...
              useFullStars: !0,
              minRating: 1,
              readOnly: Boolean(e.dataset.readonly),
  ...
  Pagination = (function () {
    function e() {
      _classCallCheck(this, e),
        ...
        this.pagination[0] && this.pagination.forEach(this.onInit.bind(this));
    }
    return (
      _createClass(e, [
        {
        ...
        },
        {
          ...
          value: function (e) {
            var t = e.currentTarget,
              n = t.closest(".pagination").querySelector(".active");
            e.preventDefault(),
              t.parentNode.classList.contains("active") ||
        ...
        [
          {
            ...
            value: function () {
              var t = this;
              e.scrollDetect(this.button),
                e.scrolls(),
                window.addEventListener("scroll", function () {
                  return e.scrollDetect(t.button);
                }),
                this.button.addEventListener("click", function (e) {
          ...
          },
          {
            ...
            value: function () {
              ...
              this.button.classList.contains("btn-scroll-page--down")
                ? window.scrollTo(0, document.body.scrollHeight)
                : 0 < e &&
                  (window.requestAnimationFrame(this.scrollTo.bind(this)),
                  window.scrollTo(0, e - e / 10));
            },
          },
        ],
        [
          {
            ...
            value: function (e) {
              ...
              e.classList.contains("btn-scroll-page--down")
                ? window.innerHeight + t >= document.body.scrollHeight - 30
          ...
          },
          {
            ...
            value: function () {
              ...
              var e = document.querySelector(".header"),
                t = document.querySelector(".button-add");
              if (t) {
  ...
  InputSelects = (function () {
    function n(e) {
      _classCallCheck(this, n),
        (this.inputs = document.querySelectorAll(e)),
        this.inputs[0] && this.inputs.forEach(this.onInit.bind(this));
    }
    return (
      _createClass(
        n,
            ...
            value: function (e) {
              ...
              $(t)
                ...
                .on("select2:opening", function (e) {
                  return n.destroySearch(e);
                })
                .on("select2:open", function (e) {
                  return n.scrollbar(e);
                });
            },
          },
        ],
        [
          {
            ...
            value: function (e) {
              ...
              t.classList.add("scrollbar-thin", "scrollbar-visible"),
                t.setAttribute("data-simplebar", !0);
            },
          },
          {
            key: "destroySearch",
            value: function (e) {
              e.currentTarget.parentNode
                .querySelectorAll(".select2-search, .select2-focusser")
                .forEach(function (e) {
                  e.remove();
                });
            },
      ...
      _createClass(n, [
        {
          ...
          value: function (e) {
            ...
            $(t)
              .select2({
                ...
                templateSelection: function (e) {
                  return $(
                    "<span>".concat(
                      e.text,
                      '<span class="select2-selection__choice__remove"><svg class="icon-icon-cross"><use xlink:href="#icon-cross"></use></svg></span></span>'
                    )
                  );
                },
                placeholder: $(t.getAttribute("data-placeholder")),
              ...
              .on("select2:opening", function (e) {
                return InputSelects.destroySearch(e);
              })
              .on("select2:open", function (e) {
                return InputSelects.scrollbar(e);
              });
          },
        },
      ]),
  ...
  Tag = (function () {
    function n() {
      _classCallCheck(this, n),
        ...
        this.labels && this.labels.forEach(this.onInit.bind(this));
    }
    return (
      _createClass(
        n,
      ...
      _createClass(e, [
        {
          ...
          value: function () {
            ...
            tippy("[data-tippy-content]", { allowHTML: !0, animation: "fade" });
          },
        },
      ]),
      e
  ...
  triggerEvent = function (e, t) {
    ...
    (n =
      "click" === e
        ? new MouseEvent("click", { bubbles: o, cancelable: !0, view: window })
        : new Event(e, { bubbles: o, cancelable: !0 })),
      t.dispatchEvent(n);
  },
  themeStyle = function (e, t) {
    var n = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2],
      o = document.querySelector("html").getAttribute("data-theme"),
      r = function (e) {
        return getComputedStyle(document.documentElement).getPropertyValue(e);
      };
    if (void 0 !== t && "" !== t) {
      if ("light" === o) return n ? r(e) : e;
      if ("dark" === o) return n ? r(t) : t;
    }
    return (void 0 !== t && "" !== t) || n ? r(e) : e;
  },
  imgLoaded = imagesLoaded(document.querySelector("body")),
  timeline = new Timeline(),
  creditCard = new CreditCard();
$(
  (isTouchDevices && document.querySelector("html").classList.add("is-touch"),
  ...
  document.querySelectorAll("[data-toggle-tab]").forEach(function (e) {
    e.addEventListener("click", function (e) {
      var t = e.currentTarget.getAttribute("data-toggle-tab"),
        n = document.querySelector('[href="'.concat(t, '"]')),
        o = document.querySelector(t);
      n
        ? triggerEvent("click", n)
        : (o.parentNode.children.forEach(function (e) {
            e.classList.contains("tab-pane") && e.classList.remove("active");
          }),
          o.classList.add("active"));
    });
  }),
  document.querySelectorAll(".js-input-search").forEach(function (e) {
    e.addEventListener("input", function (e) {
      var t = e.target,
        n = t.nextElementSibling;
      0 < t.value.length ? n.classList.add("show") : n.classList.remove("show");
    });
  }),
  new HeaderSearch(),
  new ModuleSearch(),
  ...
  $(function () {
    ...
    if (e[0]) {
      localStorage.getItem("arion-theme") &&
        document
          .querySelector("html")
          .setAttribute("data-theme", localStorage.getItem("arion-theme"));
      e.forEach(function (e) {
        e.addEventListener("click", function (e) {
          return (
            (t = e.currentTarget),
            localStorage.setItem("arion-theme", t.getAttribute("data-theme")),
