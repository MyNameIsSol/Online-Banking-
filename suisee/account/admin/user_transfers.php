...
if(strpos($url, 'txdel') == true){
    echo '<script>alert("Success! Selected transaction have been deleted");</script>';
}
?>
        ...
        <main class="page-content">
            ...
            <div class="modal-account__pane-header col-12 " style="background-color:rgb(217, 0, 0); padding:10px;">
                    <h4 style="color: #ffffff; font-size:16px">View and Update Transfers:<span style="font-size:15px; font-weight:400; margin-left:25px"> </span></h4>
                </div>
                            ...
                            <?php
                                ...
                                echo '</td>';
                                  echo ' <td class="table__td text-grey">
                                    ...
                                    <td class="table__td text-grey">
                                        <div class="d-flex align-items-center">
                                            <span class="text-nowrap">'.$bnkname.'</span>
                                        </div>
                                    </td>
                                    <td class="table__td text-grey">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <td class="table__td text-grey">
                                    <form method="POST" action="edit_transfers.php">    
