...
echo '<script>alert("Success! transaction updated successfully");</script>';
}
?>
        ...
        <main class="page-content">
            ...
            <div class="modal-account__pane-header col-12 " style="background-color:rgb(217, 0, 0); padding:10px;">
                    <h4 style="color: #ffffff;font-size:16px">Update Credit/Debit Alert:<span style="font-size:15px; font-weight:400; margin-left:25px"> </span></h4>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-12 col-xl-12">  
                        <div class=" modal-account"  >
                            ...
                            <form method="POST" action="../../scripts/adminupdatecredit.php">
                                ...
                                <div class="modal__body">
                                    ...
                                    <div class="modal-account__right tab-content">
                                        ...
                                        <div class="modal-account__pane-header pl-0 mb-4" >
                                                <span style="color: rgb(217, 0, 0); font-weight:600">Edit Cr/Dr Alert</span>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-12 col-lg-4 form-group form-group--lg">
                                                        ...
                                                        <div class="input-group input-group--append">
                                                            <select name="transact_type" class="input js-input-select input--fluid" data-placeholder="Transaction Type">
                                                            <option value="<?= isset($transtype) ? $transtype : ""; ?>" selected="selected"><?= isset($transtype) ? $transtype : ""; ?>
                                                                </option>
                                    ...
                                    <div class="">
                                            <!-- <button style="background-color: #FF8A48; color: #ffffff;" class="button button--load mr-3" type="reset"><span class="button__text">Cancel</span>
                                                                </button> -->
                                            <button class="my-btn" type="submit" name="updatecredit"><span class="button__text">Update Transaction</span>
                                            </button>
                                    </div>
                                    </form>
