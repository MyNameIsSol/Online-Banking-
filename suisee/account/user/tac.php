...
if(!isset($_POST['transfer'])){
    ...
    isset($_POST['bbank']) ? $bbank = mysqli_real_escape_string($conn,$_POST['bbank']) : $bbank = "-";
...
var inputedtac = document.forms["transfer"]["inputedtac"].value;
  var tac = document.forms["transfer"]["tac"].value;
  
  if(inputedtac != tac){

    alert('Invalid Tac Code! please provide a valid Tac Code..');
    return false;
                    ...
                    <div class="col-12 col-md-8 col-lg-8 col-xl-8">  
                        <div class=" modal-account"  >
                            ...
                            <div class="modal__window">
                                ...
                                <form class="" name="transfer" method="POST" action="tax.php" onsubmit="return validateForm()">
                                        <div class="modal-account__pane-header" style="background-color:rgb(217, 0, 0); padding:10px;">
                                                    <h4 style="color: #ffffff; font-size:16px">Tac Code Requird</h4>
                                                </div>
                                               
                                                    <h6 class="ml-4">Provide the Tac Code  and click continue to <br> proceed. </h6>
                                            ...
                                            <div class="modal-account__pane tab-pane show active" id="accountDetails">
                                                    ...
                                                    <div class="row row--md">
                                                        <div class="col-12 col-lg-12 form-group form-group--lg">
                                                            <label class="form-label form-label--sm text-danger">Enter Tac Code</label>
                                                            <div class="input-group">
                                                                <input class="input"  type="text" name="inputedtac" placeholder="Enter your Tac Code" >
                                                            </div>
                                                        </div>
                                                        <h5 style="font-size:10px;">Don't know your Tac code? <a href="mailto:finance@clickstateonline.com" class="text-primary">Send us a message.</a></h5>
                                                    </div>
                                                        ...
                                                        <div class="card__container p-0">
                                                            <div class="row gutter-bottom-sm justify-content-end">
                                                                ...
                                                                <div class="card-order__footer-submit col-12 col-sm">
                                                                    <button class="my-btn" name='transfer' type="submit"><span class="button__text">Continue</span><span class="ml-1"></span>
                                                                    </button>
                                                                </div>
