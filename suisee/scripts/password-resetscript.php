...
include_once('phpmaile/PHPMailerAutoload.php');
    if(isset($_POST['reset'])){
         ...
         if(empty($email)){
             header("Location:../dashboard/reset_password.php?loginempty");
            exit();
         ...
         if($result_check < 1){
            header("Location:../dashboard/reset_password.php?invaliduid");
         exit();
         }else{
    ...
    <td align="center" style="padding: 0px 10px 0px 10px;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
        ...
        <td bgcolor="#ffffff" align="left" style="padding: 10px 10px 20px 10px; color: #666666; font-family: "Poppins", sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
              <p style="margin:10px 13px; font-size: 14px; text-align:center; color:green;">We received your request to reset your password.</p>
        </td>
        </tr>
        ...
        <td bgcolor="#ffffff" align="left" style="padding: 10px 10px 40px 10px; color: #111111; font-family: "Poppins", sans-serif; font-size: 14px; font-weight: 400; line-height: 25px;">
          <h2 style="font-size: 13px; font-weight: 600; margin: 10px 13px; text-align:center; color:red;">Here is the detail of your account. Please <a href="https://www.clickstateonline.com/login.php">Login </a>to reset your password.</h2>
        </td>
        </tr>
        <!-- COPY -->
        <tr>
        <td bgcolor="#ffffff" align="center" style="padding: 10px 10px 20px 10px; color: #666666; font-family: "Poppins", sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
          ...
          <p style="margin: 10px 13px; font-size: 12px;">Password: '.$pwd.'</p>
                    <p style="margin: 10px 13px; font-size: 12px;">Pin: '.$pin.'</p>
        </td>
        </tr>
        <!-- COPY -->
        <tr>
...
header("Location:../login.php?resetsuc");
    exit();
        }
    }
}
